...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "tertiary", colorKey: variant === variants$1.PRIMARY ? "primary" : "primary" }, props)));
    }
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement("img", { src: "https://github.com/MERMAIDSWAP-MERD/Mermaid-UI-Kit/blob/master/src/widgets/Menu/Rugdoc.png", alt: "rugdocimage1", style: { width: "100%" } }),
